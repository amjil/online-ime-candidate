(ns online-ime-candidate.test.handler
  (:require
    [clojure.test :refer :all]
    [ring.mock.request :refer :all]
    [online-ime-candidate.handler :refer :all]
...
(use-fixtures
  :once
  (fn [f]
    (mount/start #'online-ime-candidate.config/env
                 #'online-ime-candidate.handler/app-routes)
    (f)))
